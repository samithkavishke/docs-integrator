---
title: "DocuSign - Examples"
description: "Code examples for the ballerinax/docusign.dsadmin connector."
---
...
public function main() returns error? {
    // Initialize client
    dsadmin:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to DocuSign successfully");
}
```
