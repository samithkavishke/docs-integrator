---
title: "SendGrid - Examples"
description: "Code examples for the ballerinax/sendgrid connector."
---
...
public function main() returns error? {
    // Initialize client
    sendgrid:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to SendGrid successfully");
}
```
