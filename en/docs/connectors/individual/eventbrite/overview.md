---
title: "Eventbrite"
description: "Overview of the ballerinax/eventbrite connector for WSO2 Integrator."
---
...
| | |
|---|---|
| **Package** | [`ballerinax/eventbrite`](https://central.ballerina.io/ballerinax/eventbrite/latest) |
| **Version** | latest |
| **Category** | Social & Other |
| **Ballerina Central** | [View on Central](https://central.ballerina.io/ballerinax/eventbrite/latest) |
| **API Docs** | [API Reference](https://central.ballerina.io/ballerinax/eventbrite/latest) |

## Overview

Connect to Eventbrite from Ballerina.
...
Use the Eventbrite connector when your integration needs to:
...
- [API Documentation](https://central.ballerina.io/ballerinax/eventbrite/latest)
