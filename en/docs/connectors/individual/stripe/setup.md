---
title: "Stripe - Setup"
description: "How to set up and configure the ballerinax/stripe connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/stripe/latest).
