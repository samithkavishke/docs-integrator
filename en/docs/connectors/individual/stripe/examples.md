---
title: "Stripe - Examples"
description: "Code examples for the ballerinax/stripe connector."
---
...
public function main() returns error? {
    // Initialize client
    stripe:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Stripe successfully");
}
```
