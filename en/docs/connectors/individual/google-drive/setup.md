...
description: "How to set up and configure the ballerinax/googleapis.drive connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/googleapis.drive/latest).
