---
title: "Google Drive - Examples"
description: "Code examples for the ballerinax/googleapis.drive connector."
---
...
public function main() returns error? {
    // Initialize client
    drive:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Google Drive successfully");
}
```
