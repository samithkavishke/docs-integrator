---
title: "Shopify - Setup"
description: "How to set up and configure the ballerinax/shopify.admin connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/shopify.admin/latest).
