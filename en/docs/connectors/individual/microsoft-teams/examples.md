---
title: "Microsoft Teams - Examples"
description: "Code examples for the ballerinax/microsoft.teams connector."
---
...
public function main() returns error? {
    // Initialize client
    teams:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Microsoft Teams successfully");
}
```
