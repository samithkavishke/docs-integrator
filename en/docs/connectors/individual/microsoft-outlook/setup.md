...
description: "How to set up and configure the ballerinax/microsoft.outlook.mail connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/microsoft.outlook.mail/latest).
