---
title: "Spotify - Setup"
description: "How to set up and configure the ballerinax/spotify connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/spotify/latest).
