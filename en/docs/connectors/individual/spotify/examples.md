---
title: "Spotify - Examples"
description: "Code examples for the ballerinax/spotify connector."
---
...
public function main() returns error? {
    // Initialize client
    spotify:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Spotify successfully");
}
```
