...
description: "How to set up and configure the ballerinax/googleapis.gcalendar connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/googleapis.gcalendar/latest).
