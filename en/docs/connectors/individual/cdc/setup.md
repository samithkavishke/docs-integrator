---
title: "Change Data Capture - Setup"
description: "How to set up and configure the ballerinax/cdc connector."
---
...
3. Search for **Change Data Capture**
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/cdc/latest).
