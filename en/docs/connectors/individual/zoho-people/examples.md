---
title: "Zoho People - Examples"
description: "Code examples for the ballerinax/zoho.people connector."
---

# Zoho People Examples
...
public function main() returns error? {
    ...
    io:println("Connected to Zoho People successfully");
}
```
