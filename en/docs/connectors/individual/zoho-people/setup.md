---
title: "Zoho People - Setup"
description: "How to set up and configure the ballerinax/zoho.people connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/zoho.people/latest).
