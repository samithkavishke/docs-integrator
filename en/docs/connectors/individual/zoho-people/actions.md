---
title: "Zoho People - Actions"
description: "Available actions and operations for the ballerinax/zoho.people connector."
---

# Zoho People Actions

The `ballerinax/zoho.people` package provides a client with operations to interact with Zoho People.
...
For the complete list of operations and their parameters, see the [API documentation](https://central.ballerina.io/ballerinax/zoho.people/latest#clients).
