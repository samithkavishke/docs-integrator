---
title: "Shopify Trigger - Setup"
description: "How to set up and configure the ballerinax/trigger.shopify connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/trigger.shopify/latest).
