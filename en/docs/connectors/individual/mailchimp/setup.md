...
description: "How to set up and configure the ballerinax/mailchimp connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/mailchimp/latest).
