...
description: "How to set up and configure the ballerinax/azure.keyvault connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/azure.keyvault/latest).
