---
title: "Weaviate Vector Search - Setup"
description: "How to set up and configure the ballerinax/weaviate connector."
---

# Weaviate Vector Search Setup
...
3. Search for **Weaviate Vector Search**
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/weaviate/latest).
