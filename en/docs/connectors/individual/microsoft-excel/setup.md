---
title: "Microsoft Excel - Setup"
description: "How to set up and configure the ballerinax/microsoft.excel connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/microsoft.excel/latest).
