---
title: "SAP JCo - Examples"
description: "Code examples for the ballerinax/sap.jco connector."
---
...
public function main() returns error? {
    // Initialize client
    jco:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to SAP JCo successfully");
}
```
