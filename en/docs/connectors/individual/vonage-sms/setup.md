---
title: "Vonage SMS - Setup"
description: "How to set up and configure the ballerinax/vonage.sms connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/vonage.sms/latest).
