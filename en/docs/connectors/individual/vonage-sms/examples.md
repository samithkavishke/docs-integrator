---
title: "Vonage SMS - Examples"
description: "Code examples for the ballerinax/vonage.sms connector."
---
...
public function main() returns error? {
    // Initialize client
    sms:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Vonage SMS successfully");
}
```
