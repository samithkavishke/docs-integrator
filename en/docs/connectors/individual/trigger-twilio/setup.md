---
title: "Twilio Trigger - Setup"
description: "How to set up and configure the ballerinax/trigger.twilio connector."
---

# Twilio Trigger Setup
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/trigger.twilio/latest).
