---
title: "Amazon Redshift - Setup"
description: "How to set up and configure the ballerinax/aws.redshift connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/aws.redshift/latest).
