---
title: "Amazon Redshift - Examples"
description: "Code examples for the ballerinax/aws.redshift connector."
---
...
public function main() returns error? {
    // Initialize client
    redshift:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Amazon Redshift successfully");
}
```
