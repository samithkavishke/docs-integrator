---
title: "SCIM Identity Management"
description: "Overview of the ballerinax/scim connector for WSO2 Integrator."
---
...
| | |
|---|---|
| **Package** | [`ballerinax/scim`](https://central.ballerina.io/ballerinax/scim/latest) |
| **Version** | latest |
| **Category** | Enterprise |
| **Ballerina Central** | [View on Central](https://central.ballerina.io/ballerinax/scim/latest) |
| **API Docs** | [API Reference](https://central.ballerina.io/ballerinax/scim/latest) |

## Overview

Connect to SCIM Identity Management from Ballerina.
...
Use the SCIM Identity Management connector when your integration needs to:
...
- [API Documentation](https://central.ballerina.io/ballerinax/scim/latest)
