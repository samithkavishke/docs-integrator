---
title: "SCIM - Examples"
description: "Code examples for the ballerinax/scim connector."
---
...
public function main() returns error? {
    // Initialize client
    scim:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to SCIM successfully");
}
```
