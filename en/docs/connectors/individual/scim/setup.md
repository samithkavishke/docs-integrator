---
title: "SCIM - Setup"
description: "How to set up and configure the ballerinax/scim connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/scim/latest).
