---
title: "Microsoft OneDrive - Examples"
description: "Code examples for the ballerinax/microsoft.onedrive connector."
---

# Microsoft OneDrive Examples
...
public function main() returns error? {
    // Initialize client
    onedrive:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Microsoft OneDrive successfully");
}
```
