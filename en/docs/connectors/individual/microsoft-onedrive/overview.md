...
description: "Overview of the ballerinax/microsoft.onedrive connector for WSO2 Integrator."
---
...
| | |
|---|---|
| **Package** | [`ballerinax/microsoft.onedrive`](https://central.ballerina.io/ballerinax/microsoft.onedrive/latest) |
| **Version** | latest |
| **Category** | Microsoft |
| **Ballerina Central** | [View on Central](https://central.ballerina.io/ballerinax/microsoft.onedrive/latest) |
| **API Docs** | [API Reference](https://central.ballerina.io/ballerinax/microsoft.onedrive/latest) |

## Overview

Connect to Microsoft OneDrive from Ballerina.
...
Use the Microsoft OneDrive connector when your integration needs to:

- Integrate with the platform's API
...
- [API Documentation](https://central.ballerina.io/ballerinax/microsoft.onedrive/latest)
