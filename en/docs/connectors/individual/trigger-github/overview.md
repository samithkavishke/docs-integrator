...
description: "Overview of the ballerinax/trigger.github connector for WSO2 Integrator."
---
...
| | |
|---|---|
| **Package** | [`ballerinax/trigger.github`](https://central.ballerina.io/ballerinax/trigger.github/latest) |
| **Version** | latest |
| **Category** | Triggers |
| **Ballerina Central** | [View on Central](https://central.ballerina.io/ballerinax/trigger.github/latest) |
| **API Docs** | [API Reference](https://central.ballerina.io/ballerinax/trigger.github/latest) |

## Overview

Connect to GitHub Trigger from Ballerina.
...
Use the GitHub Trigger connector when your integration needs to:
...
- [API Documentation](https://central.ballerina.io/ballerinax/trigger.github/latest)
