---
title: "Google People - Examples"
description: "Code examples for the ballerinax/googleapis.people connector."
---

# Google People Examples
...
public function main() returns error? {
    // Initialize client
    people:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to Google People successfully");
}
```
