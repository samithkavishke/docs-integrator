...
description: "How to set up and configure the ballerinax/milvus connector."
---
...
3. Search for **Milvus Vector Database**
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/milvus/latest).
