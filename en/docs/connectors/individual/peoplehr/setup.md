---
title: "PeopleHR - Setup"
description: "How to set up and configure the ballerinax/peoplehr connector."
---
...
For detailed configuration options, see the [API documentation](https://central.ballerina.io/ballerinax/peoplehr/latest).
