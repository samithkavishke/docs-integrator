---
title: "PeopleHR - Examples"
description: "Code examples for the ballerinax/peoplehr connector."
---
...
public function main() returns error? {
    // Initialize client
    peoplehr:Client client = check new ({
        auth: { token: token }
    });
    
    io:println("Connected to PeopleHR successfully");
}
```
